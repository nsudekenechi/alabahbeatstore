    ...
    <div>
            ...
            data.map((item, index) => (
              <tr
                ...
                className={`h-[60px] border-b border-black/20 text-sm font-display capitalize  ${
                  selectedDeleteLicense == item._id
      ...
      >
        <div
          ...
          }  duration-300 w-[40%] bg-white h-[300px]  rounded-4xl overflow-auto shadow-2xl shadow-black/5 py-10`}
        >
          ...
          >
            ...
            >
              <textarea
                ...
                className={`capitalize outline-none duration-500 h-[100%] w-[100%] resize-none ${
                  inputs.description.isFocused ? "pl-1" : ""
                }`}
                required
            ...
            <div className="md:w-[80%] grid md:grid-cols-2 gap-3 text-xs">
              <div className="grid gap-1">
                ...
                <div
                  className={`border duration-300 ${
                    inputs.price.isFocused ? "border-accent " : "border-[#999] "
              ...
              <div className="grid gap-1">
                ...
                >
                  <input
                    ...
                    className={`capitalize outline-none duration-500 w-[100%] ${
                      inputs.termsOfYears.isFocused ? "pl-1" : ""
                    }`}
                    required
                    placeholder=""
                    onFocus={() =>
              ...
              <div className="grid gap-1">
                ...
                >
                  <input
                    ...
                    className={`capitalize outline-none duration-500 w-[100%] ${
                      inputs.distributionCopies.isFocused ? "pl-1" : ""
                    }`}
                    required
                    placeholder=""
                    onFocus={() =>
              ...
              <div className="grid gap-1">
                ...
                >
                  <input
                    ...
                    className={`capitalize outline-none duration-500 w-[100%] ${
                      inputs.audioStreams.isFocused ? "pl-1" : ""
                    }`}
                    required
                    placeholder=""
                    onFocus={() =>
